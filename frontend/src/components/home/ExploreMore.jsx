...
const ExploreMore = () => {
  ...
  const exploreCards = [
    { title: "Specialized Plastic Components", desc: "High-quality industrial plastic parts and specialized product moulds engineered for durability.", img: img('explore-01-technical-papers', "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80") },
    { title: "Precision Industrial Pins", desc: "Advanced agate & pin sets and fine industrial fastening solutions for complex machinery.", img: img('explore-02-case-studies', "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&q=80") },
    { title: "Mechanical Engineering Tools", desc: "Very fine mechanical equipment and specialized tools designed for high-precision manufacturing.", img: img('explore-03-sustainability', "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80") },
    { title: "Customized Industrial Moulds", desc: "Tailor-made industrial moulds and heavy-duty casting solutions for diverse production needs.", img: img('explore-04-career-opportunities', "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80") }
  ];
