  ...
  if (mongoose.connection.readyState !== 1 && req.path.startsWith('/api')) {
    ...
    if (req.path === '/api/settings') {
      return res.json({
        ...
        'gallery-01-casting-unit': '/uploads/26 agate & Pin.jpg', 
        'gallery-02-machining-center': '/uploads/Circular Knife.jpg', 
        'gallery-03-quality-control': '/uploads/Fine industrial Pin.jpg',
        'gallery-05-testing-lab': '/uploads/Coated Teflon Mould.jpg',
        ...
        'trusted-04-automation-control': '/uploads/Very Fine tools Mechanical very fine equipments.jpg',
        ...
        'explore-01-technical-papers': '/uploads/project-01-paper-mill-mena.jpg',
        'explore-02-case-studies': '/uploads/project-07.jpg',
